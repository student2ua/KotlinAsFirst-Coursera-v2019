 ...
 */
fun quadraticEquqationRoot(a: Double, b: Double, c: Double) =
...
fun thirdDigit(number: Int): Int {
    ...
    return toString.takeLast(3).toInt()/100
}
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (1.0+percent.div(100.0)).pow(3) * initial
